...
return new class extends Migration
{
    ...
    {
        Schema::create('secondment_weekly_report_challenge_functional_areas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('secondment_weekly_report_challenge_functional_areas');
    }
};
