(function (global, factory) {
  ...
  -----------------------------------------------*/
    ...
    //                   // Apply Bootstrap size classes to Choices wrapper
    //    const wrapper = item.closest('.choices') 
    //     || item.parentElement?.querySelector('.choices');

    //   if (wrapper) {
    //     if (item.classList.contains('form-select-lg')) wrapper.classList.add('choices-lg');
    //     if (item.classList.contains('form-select-sm')) wrapper.classList.add('choices-sm');
    //   }
  ...
  -----------------------------------------------*/
    ...
    const flatpickrInit = () => {
        ...
        document.querySelectorAll(".datetimepicker").forEach((item) => {
         ...
         const fp =   window.flatpickr(item, {
