                ...
                <table id="report_table" data-toggle="table"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="demand_of_day">Demand of the Day</th>
                            <th data-field="attended">Attended</th>
                            <th data-field="attendance_percentage">Attendance %</th>
                            <th data-field="meals_ordered_volunteers">Meals Ordered (Volunteers)</th>
                            <th data-field="meals_redeemed_volunteers">Meals Redeemed (Volunteers)</th>
                            <th data-field="volunteer_meal_percentage">Volunteer Meal %</th>
                            <th data-field="meals_ordered_staff">Meals Ordered (Staff)</th>
                            <th data-field="meals_redeemed_staff">Meals Redeemed (Staff)</th>
                            <th data-field="staff_meal_percentage">Staff Meal %</th>
