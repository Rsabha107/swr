            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent {{ Request::is('wdr/report*') || Request::is('swr/report*') ? 'show' : '' }}"
                                data-bs-parent="#navbarVerticalCollapse" id="nv-guest">
                                <li class="collapsed-nav-item-title d-none">Reports</li>

                                <!-- Guest main pages -->
                                <li class="nav-item">
                                    <a class="nav-link {{ Request::is('wdr/report') ? 'active' : '' }}"
                                        href="{{ route('wdr.report') }}">
                                        <div class="d-flex align-items-center">
                                ...
                                <!-- Guest main pages -->
                                <li class="nav-item">
                                    <a class="nav-link {{ Request::is('swr/report') ? 'active' : '' }}"
                                        href="{{ route('swr.report') }}">
                                        <div class="d-flex align-items-center">
