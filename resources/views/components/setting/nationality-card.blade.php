...
<div class="card mt-4">
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            {{$slot}}
            <input type="hidden" id="data_type" value="nationality"> 
            <div class="mx-2 mb-2">
                <table id="nationalities_table"
                    data-toggle="table"
                    data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                    data-loading-template="loadingTemplate"
                    data-url="{{ route('wdr.setting.nationality.list')}}"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-sortable="true" data-field="alpha_3_code" ><?= get_label('Alpha 3 Code', 'Alpha 3 Code') ?></th>
