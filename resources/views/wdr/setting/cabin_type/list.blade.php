...
@section('main')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <?= get_label('cabin_types', 'Cabin Types') ?>
                    </li>
                </ol>
            </nav>
        </div>
        <div>
            <x-button_insert_modal bstitle='Add Cabin Types' bstarget="#create_cabin_types_modal" />
    ...
    <x-setting.cabin_type-card />
    {{-- </div> --}}

    @include('wdr.setting.modals.gms_cabin_type_modals')
    <script>
    ...
    <script src="{{ asset('assets/js/pages/gms/cabin_types.js') }}"></script>
@endsection
