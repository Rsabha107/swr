...
@section('main')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <?= get_label('airlines', 'Airlines') ?>
                    </li>
                </ol>
            </nav>
        </div>
        <div>
            <x-button_insert_modal bstitle='Add Airlines' bstarget="#create_airlines_modal" />
    ...
    <x-setting.airline-card />
    {{-- </div> --}}

    @include('wdr.setting.modals.gms_airline_modals')
    <script>
    ...
    <script src="{{ asset('assets/js/pages/gms/airline.js') }}"></script>
@endsection
