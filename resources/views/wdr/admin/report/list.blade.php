...
@section('main')
    ...
    <div class="d-flex justify-content-between m-2">
        ...
        <div>
            ...
            <ul class="dropdown-menu dropdown-menu-end" style="">
                ...
                <li>
                    <form method="POST" action="{{ route('wdr.admin.report.export') }}" id="filter_export_form">
                        @csrf
    ...
    <x-wdr.admin.report-card />

    @include('wdr.admin.report.modals.wdr_modal')

    <script src="{{ asset('assets/js/pages/wdr/admin/report.js') }}"></script>
@endsection
