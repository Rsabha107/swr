...
@section('main')
    <nav class="mb-3" aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('wdr.report') }}">Daily Reports</a></li>
    ...
    <div class="mb-9">
        ...
        <div class="d-flex flex-wrap gap-3 justify-content-between mb-4">
            {{-- <div>
                <button class="btn btn-link  me-4 px-0 text-white"><span
                        class="fa-solid fa-file-export fs-9 me-2 text-white"></span>Export</button>
            </div> --}}
            <div>
