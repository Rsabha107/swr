...
@section('main')
    ...
    <div class="d-flex justify-content-between m-2">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <?= get_label('workforce_daily_reports', 'Workforce Daily Reports') ?>
                    </li>
                </ol>
            </nav>
        </div>
        <div>
            ...
            <ul class="dropdown-menu dropdown-menu-end" style="">
                ...
                <li>
                    <form method="POST" action="{{ route('swr.admin.report.export') }}" id="filter_export_form">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-link p-2 m-2 align-baseline">
                            <span class="fa-solid fa-download text-success me-2"></span>Export Filtered Results
                        </button>
                    </form>
                    {{-- <a class="dropdown-item ms-2 text-success me-2" href="{{ route('swr.admin.booking.export') }}">
    ...
    <x-swr.admin.report-card />

    @include('swr.admin.report.modals.swr_modal')

    <script src="{{ asset('assets/js/pages/swr/admin/report.js') }}"></script>
@endsection
