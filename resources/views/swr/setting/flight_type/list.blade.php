...
@section('main')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <?= get_label('flight_types', 'Flight Types') ?>
                    </li>
                </ol>
            </nav>
        </div>
        <div>
            <x-button_insert_modal bstitle='Add Flight Types' bstarget="#create_flight_types_modal" />
    ...
    <x-setting.flight_type-card />
    {{-- </div> --}}

    @include('wdr.setting.modals.gms_flight_type_modals')
    <script>
    ...
    <script src="{{ asset('assets/js/pages/gms/flight_type.js') }}"></script>
@endsection
