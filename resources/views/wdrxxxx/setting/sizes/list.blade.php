...
@section('main')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <?= get_label('sizes', 'Sizes') ?>
                    </li>
                </ol>
            </nav>
        </div>
        <div>
            <x-button_insert_modal bstitle='Add Sizes' bstarget="#create_sizes_modal" />
    ...
    <x-setting.sizes-card />
    {{-- </div> --}}

    @include('wdr.setting.modals.sizes_modals')
    <script>
    ...
    <script src="{{ asset('assets/js/pages/wdr/sizes.js') }}"></script>
@endsection
