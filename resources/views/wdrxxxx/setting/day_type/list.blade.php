...
@section('main')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <?= get_label('day_types', 'Day Type') ?>
                    </li>
                </ol>
            </nav>
        </div>
        <div>
            <x-button_insert_modal bstitle='Add Day Type' bstarget="#create_day_types_modal" />
    ...
    <x-setting.day_type-card />
    {{-- </div> --}}

    @include('wdr.setting.modals.day_type_modals')
    <script>
    ...
    <script src="{{ asset('assets/js/pages/wdr/day_type.js') }}"></script>
@endsection
