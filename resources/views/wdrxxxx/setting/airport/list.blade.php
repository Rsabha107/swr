...
@section('main')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <?= get_label('airports', 'Airport') ?>
                    </li>
                </ol>
            </nav>
        </div>
        <div>
            <x-button_insert_modal bstitle='Add Airport' bstarget="#create_airports_modal" />
    ...
    <x-setting.airport-card />
    {{-- </div> --}}

    @include('wdr.setting.modals.gms_airport_modals')
    <script>
    ...
    <script src="{{ asset('assets/js/pages/gms/airport.js') }}"></script>
@endsection
