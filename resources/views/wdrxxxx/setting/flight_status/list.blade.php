...
@section('main')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <?= get_label('flight_statuses', 'Flight Status') ?>
                    </li>
                </ol>
            </nav>
        </div>
        <div>
            <x-button_insert_modal bstitle='Add Flight Status' bstarget="#create_flight_statuses_modal" />
    ...
    <x-setting.flight_status-card />
    {{-- </div> --}}

    @include('wdr.setting.modals.gms_flight_status_modals')
    <script>
    ...
    <script src="{{ asset('assets/js/pages/gms/flight_status.js') }}"></script>
@endsection
