...
@section('main')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <?= get_label('hosted_bys', 'Hosted By') ?>
                    </li>
                </ol>
            </nav>
        </div>
        <div>
            <x-button_insert_modal bstitle='Add Hosted By' bstarget="#create_hosted_bys_modal" />
    ...
    <x-setting.hosted_by-card />
    {{-- </div> --}}

    @include('wdr.setting.modals.gms_hosted_by_modals')
    <script>
    ...
    <script src="{{ asset('assets/js/pages/gms/hosted_by.js') }}"></script>
@endsection
