...
@section('main')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <?= get_label('designations', 'Designation') ?>
                    </li>
                </ol>
            </nav>
        </div>
        <div>
            <x-button_insert_modal bstitle='Add Designation' bstarget="#create_designations_modal" />
    ...
    <x-setting.designation-card />
    {{-- </div> --}}

    @include('wdr.setting.modals.gms_designation_modals')
    <script>
