...
@section('main')
    ...
    <div class="d-flex justify-content-between m-2">
        ...
        <div>
            <x-formy.button url="{{ route('wdr.report.create') }}" title="New Report" icon="fa-solid fa-plus"
    ...
    <x-wdr.customer.report-card />

    @include('wdr.customer.report.modals.wdr_modal')

    <script src="{{ asset('assets/js/pages/wdr/customer/report.js') }}"></script>
@endsection
